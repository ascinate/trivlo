  ...
  return (
    ...
    padding: 30px;
        ...
        @media (max-width: 991.98px) {
          ...
          .login-hero { min-height: 50vh; display: block; }
          .login-hero-content { padding: 6rem 2rem 2.5rem 2rem; min-height: 50vh; }
          .login-form-panel { padding: 2.5rem 1.75rem 2rem 1.75rem; border-left: none; border-top: 1px solid var(--border); }
          .login-topbar { padding: 1rem 1.5rem; }
        }
        @media (max-width: 575.98px) {
          .login-form-panel { padding: 2rem 1.25rem; }
          .login-hero-content { padding: 5.5rem 1.25rem 2rem 1.25rem; }
